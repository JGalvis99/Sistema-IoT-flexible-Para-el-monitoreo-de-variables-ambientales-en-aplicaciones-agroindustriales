 ...
 *TRIS &= (~PIN);
  ...
  _delay((unsigned long)((240)*(32000000/4000000.0)));
 _delay((unsigned long)((240)*(32000000/4000000.0)));

  *LAT &= (~PIN);
 *TRIS |= PIN;

 _delay((unsigned long)((70)*(32000000/4000000.0)));

 presence_detect = read_OW(TRIS, PORT, PIN);

  _delay((unsigned long)((205)*(32000000/4000000.0)));
 _delay((unsigned long)((205)*(32000000/4000000.0)));
...
void OW_write_bit (unsigned char write_bit, unsigned char *TRIS, unsigned char *LAT, unsigned char PIN)
{
  ...
  *LAT &= (~PIN);
        *TRIS |= PIN;
  _delay((unsigned long)((64)*(32000000/4000000.0)));
 }
 else
 {
 ...
 *LAT &= (~PIN);
 *TRIS |= PIN;
 _delay((unsigned long)((9)*(32000000/4000000.0)));

 read_data = read_OW(TRIS, PORT, PIN);

 _delay((unsigned long)((55)*(32000000/4000000.0)));
 return read_data;
}
# 177 "1wire.c"
void OW_write_byte (unsigned char write_data, unsigned char *TRIS, unsigned char *LAT, unsigned char PIN)
{
 ...
 {
  OW_write_bit((write_data & 0x01), TRIS, LAT, PIN);
  write_data >>= 1;
 }
}
# 197 "1wire.c"
